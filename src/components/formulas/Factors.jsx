...
function Factors() {
    ...
    // Energy sources
    const [nonRenewable, setNonRenewable] = useState(2);
    ...
    let K_energy = 2
    let K_T = 3 - (landFloraPop + marineFloraPop)/100 + temperature / 100
    let K_landFauna = 5
    ...
    let K_Temp = 2
    let K_landFloraPop = landFloraPop / 1000
    let K_marineFloraPop = marineFloraPop / 1000
    let K_nonRenewable = nonRenewable / 20
    ...
    let update = () => {
        // Relationships
        setEnergy(Math.round(20*nonRenewable+10*renewable))
        ...
        setTemperature(K_Temp-K_landFloraPop-K_marineFloraPop+K_nonRenewable)
    }
